...
const RelatedResearchersSection = () => {
    ...
    return (
        <motion.section
            ref={ref}
            className="py-24 bg-gradient-to-b from-slate-950 to-slate-900 pt-24"
                    ...
                    {relatedResearchers.map((researcher) => (
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <Avatar className="h-20 w-20 mb-4 border-2 border-indigo-500/30">
                                    <AvatarImage src={researcher.avatar} alt={researcher.name} />
                                    <AvatarFallback className="bg-indigo-900">{researcher.name.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                                </Avatar>
                                ...
                                <Badge variant="outline" className="bg-indigo-900/30 text-indigo-300 border-indigo-700 mb-4">
